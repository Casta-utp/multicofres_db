...
CREATE TABLE `employee_emails` (
  ...
  CONSTRAINT `employee_emails_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`) ON DELETE CASCADE
...
INSERT INTO `employee_emails` VALUES (1,1,'juan.gonzalez@multicofres.com','Activo','2025-04-28 07:16:05','Sistema'),(2,2,'ana.martinez@multicofres.com','Activo','2025-04-28 07:16:05','Sistema'),(3,3,'pedro.ramirez@multicofres.com','Activo','2025-04-28 07:16:05','Sistema');
